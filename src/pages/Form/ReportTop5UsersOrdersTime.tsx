...
const ReportTop5UsersOrdersTime = () => {
    ...
    const handleSubmit = async (e) => {
        ...
        try {
            const response = await fetch(
                `http://35.237.124.228/api/v1/orders/report/topUsersByOrderCount?startDate=${startDate}&endDate=${endDate}`,
                {
                    method: 'GET',
                    headers: {
            ...
            console.log(result);
            const reportData = {
                reportName: "Reporte de top 5 usuarios con mas ordenes",
...
export default ReportTop5UsersOrdersTime;
