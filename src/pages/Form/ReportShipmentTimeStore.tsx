    ...
    const handleSubmit = async (e) => {
        ...
        try {
            const response = await fetch(
                `http://35.237.124.228/api/v1/shipments/reports/shipmentsByIntervalTime?startDate=${startDate}&endDate=${endDate}&storeId=${storeId}`,
                {
                    method: 'GET',
                    headers: {
            ...
            console.log(result);
            const reportData = {
                reportName: "Reporte de envios en un intervalo de tiempo y tienda",
...
export default ReportShipmentTimeStore;
