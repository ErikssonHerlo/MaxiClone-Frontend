...
const ReportTop5StoresOrdersTimeStatus = () => {
    ...
    const handleSubmit = async (e) => {
        ...
        try {
            const response = await fetch(
                `http://35.237.124.228/api/v1/orders/report/topStoresByOrderCountAndStatus?startDate=${startDate}&endDate=${endDate}&status=${status}`,
                {
                    method: 'GET',
                    headers: {
            ...
            console.log(result);
            const reportData = {
                reportName: "Reporte de top 5 tiendas con mas ordenes en un intervalo de tiempo y estado",
...
export default ReportTop5StoresOrdersTimeStatus;
