    ...
    const handleSubmit = async (e) => {
        ...
        try {
            const response = await fetch(
                `http://35.237.124.228/api/v1/catalog/reports/store/${storeId}?quantity=${quantity}`,
                {
                    method: 'GET',
                    headers: {
            ...
            console.log(result);
            const reportData = {
                reportName: "Reporte de productos en tienda con menor cantidad",
                ...
                <div className="rounded-sm border border-stroke bg-white shadow-default dark:border-strokedark dark:bg-boxdark md:w-1/2">
                    ...
                    <form onSubmit={handleSubmit}>
                        ...
                        <div className="mb-4.5">
                            ...
                            <div className="mb-4.5">
                                <label className="mb-2.5 block text-black dark:text-white">
                                    Cantidad de producto<span className="text-meta-1">*</span>
                                </label>
                                <input
                                    type="number"
                                    value={quantity}
...
export default ReportStoreProduct;
